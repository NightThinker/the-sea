...
export class Sea {
  constructor(public id: number, public name: string, public desc: string, public imagePath: string) { }
}
 let seas = [
    new Sea(
      1,
...
let seasPromise = Promise.resolve(seas);
...
export class SeaPhotoService {
  ...
  getSeas() { return seasPromise; }
 
  getSea(id: number | string) {
    return seasPromise
